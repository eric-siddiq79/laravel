  ...
  <div id="login-page">
    <div class="container">
      <form class="form-login" action="{{ route( 'register' ) }}" method="POST">
        ...
        <h2 class="form-login-heading">Create Account @if( Session::has('message')) {{Session::get('message')}} @endif </h2>
        ...
        <div class="login-wrap">
          ...
          <button class="btn btn-theme btn-block" type="submit">Create An Account</button>
          <hr>
